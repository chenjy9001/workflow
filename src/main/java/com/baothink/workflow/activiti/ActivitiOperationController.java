/*
 * 文件名：ActivitiOperationController.java
 * 版权：Copyright 2012-2016 广州宝锶信息技术有限公司
 * 创建人：陈敬尧
 * 创建时间：2017年10月18日 下午3:11:29
 * 修改人：
 * 修改时间：
 * 修改内容：
 */
 ...
 */
public class ActivitiOperationController {
...
//    }  
    ...
    public void testOperation(){
    	...
    	String activityId = "apply";
    	Map<String, Object> variables = new HashMap<>();
//    	variables.put("refect", true);
    	TaskEntity task = (TaskEntity) taskService.createTaskQuery().taskId(  
                taskId).singleResult();  
    	try {
			turnTransition(taskId, activityId, variables);
//			runtimeService.removeVariable(task.getProcessInstanceId(), "refect");
		} catch (Exception e) {
