...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            ...
            this.$dropdown =$("body").find(".city-picker-dropdown");
        ...
        bind: function () {
            ...
            $(document).on('mousedown', (this._mouteclick = function (e) {
                var $target = $(e.target);
        ...
        open: function (type) {
    		...
    		this.$dropdown.css("z-index", (index_highest * 1 + 10));
    		this.$dropdown.css("top",  this.$textspan.offset().top+this.$textspan.outerHeight());
    		this.$dropdown.css("left",  this.$textspan.offset().left);
            this.$dropdown.show();
