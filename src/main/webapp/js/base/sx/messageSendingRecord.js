$(function() {
	...
	bt.config.url.namespace = "sx/messageSendingRecord/";// url命名空间
	...
	bt.config.toolbar.btn = [ {
		...
		click : function(data) {
			bt.fn.showView('查看数据 ', [ '800px' ], $("#view_data_div").html(), data, function(layero, index) {
				...
				$(layero).find("div[class=layui-layer-content]").height(height-36);
			});
		}
	}, {
		id : "btn_refresh",
	...
	bt.config.toolbar.search = "信息标题/接收人个人名称";// 右上角搜索框的提示语句
